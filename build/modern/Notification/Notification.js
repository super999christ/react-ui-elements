...
var ProgressIndicatorIcon = function ProgressIndicatorIcon() {
  return _svg3 || (_svg3 = /*#__PURE__*/_jsx("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "20",
    height: "20",
    viewBox: "0 0 20 20",
...
var ErrorIcon = function ErrorIcon() {
  return _svg4 || (_svg4 = /*#__PURE__*/_jsx("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "20",
    height: "20",
    viewBox: "0 0 20 20",
...
var WarningIcon = function WarningIcon() {
  return _svg5 || (_svg5 = /*#__PURE__*/_jsx("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "20",
    height: "20",
    viewBox: "0 0 20 20",
...
var SuccesIcon = function SuccesIcon() {
  return _svg6 || (_svg6 = /*#__PURE__*/_jsxs("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    width: "20",
    height: "20",
    viewBox: "0 0 20 20",
...
var Notification = /*#__PURE__*/React.forwardRef(function Notification(props, ref) {
  var _props$Avatar = props.Avatar,
    Avatar = _props$Avatar === void 0 ? function () {
      return _AvatarOriginal || (_AvatarOriginal = /*#__PURE__*/_jsx(AvatarOriginal, {
        size: "md"
      }));
    } : _props$Avatar,
  ...
  var containerClasses = clsx(styles.container, className);
  var wrapperClasses = clsx(styles.wrapper);
  var mobileWrapperClasses = clsx(styles.mobile__wrapper);
  var mobileIconsContainerClasses = clsx(styles.mobile__icons__container, (type === 'no-icon' || type === 'image') && styles['mobile__icons__container--x-only']);
  ...
  var imageContainerTwoClasses = clsx(styles.image__container__two);
  ...
  var textTimeIconContainerClasses = clsx(styles.text__time__icon__container);
  var textContainerClasses = clsx(styles.text__container);
  var textTimeContainerClasses = clsx(styles.text__time__container);
  var textClasses = clsx(styles.text);
  var timeClasses = clsx(styles.time);
  var supportingTextClasses = clsx(styles.supporting__text);
  var closeIconContainerClasses = clsx(styles.close__icon__container, (type === 'no-icon' || type === 'image') && styles['close__icon__container--type-no-icon-or-image']);
  var closeIconContainerClassesNoIconOrImage = clsx(styles.close__icon__container);
  ...
  return /*#__PURE__*/_jsxs("div", _extends({
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      children: [type !== 'no-icon' && type !== 'image' && /*#__PURE__*/_jsxs("div", {
        className: mobileIconsContainerClasses,
        children: [type === 'avatar' && Avatar && Avatar(), ['primary-icon', 'gray-icon', 'progress-indicator', 'error-icon', 'warning-icon', 'success-icon'].includes(type) && /*#__PURE__*/_jsx("div", {
          className: iconContainerClasses,
          children: CustomIcon ? CustomIcon() : /*#__PURE__*/_jsxs(_Fragment, {
            children: [type === 'primary-icon' && (_PrimaryIcon || (_PrimaryIcon = /*#__PURE__*/_jsx(PrimaryIcon, {}))), type === 'gray-icon' && (_GrayIcon || (_GrayIcon = /*#__PURE__*/_jsx(GrayIcon, {}))), type === 'progress-indicator' && (_ProgressIndicatorIco || (_ProgressIndicatorIco = /*#__PURE__*/_jsx(ProgressIndicatorIcon, {}))), type === 'error-icon' && (_ErrorIcon || (_ErrorIcon = /*#__PURE__*/_jsx(ErrorIcon, {}))), type === 'warning-icon' && (_WarningIcon || (_WarningIcon = /*#__PURE__*/_jsx(WarningIcon, {}))), type === 'success-icon' && (_SuccesIcon || (_SuccesIcon = /*#__PURE__*/_jsx(SuccesIcon, {})))]
          })
        }), /*#__PURE__*/_jsx("div", {
        ...
        children: [/*#__PURE__*/_jsxs("div", {
          ...
          children: [/*#__PURE__*/_jsxs("div", {
            ...
            children: [/*#__PURE__*/_jsxs("div", {
              ...
              children: [typeof Text === 'string' ? /*#__PURE__*/_jsx("h1", {
                ...
                children: Text
              }) : Text(), time && /*#__PURE__*/_jsx("span", {
                className: timeClasses,
                children: time
              })]
            }), (type === 'no-icon' || type === 'image') && /*#__PURE__*/_jsx("div", {
          ...
          }), SupportingText && (typeof SupportingText === 'string' ? /*#__PURE__*/_jsx("p", {
            className: supportingTextClasses,
            children: SupportingText
          }) : SupportingText())]
        }), type === 'image' && imageLink && /*#__PURE__*/_jsx("div", {
      ...
      children: [type !== 'no-icon' && /*#__PURE__*/_jsxs(_Fragment, {
        children: [type === 'image' && imageLink && /*#__PURE__*/_jsx("div", {
          className: imageContainerClasses,
          children: /*#__PURE__*/_jsx("img", {
            src: imageLink,
            alt: imageAlt
          })
        }), type === 'avatar' && Avatar && Avatar(), ['primary-icon', 'gray-icon', 'progress-indicator', 'error-icon', 'warning-icon', 'success-icon'].includes(type) && /*#__PURE__*/_jsx("div", {
          className: iconContainerClasses,
          children: CustomIcon ? CustomIcon() : /*#__PURE__*/_jsxs(_Fragment, {
            children: [type === 'primary-icon' && (_PrimaryIcon2 || (_PrimaryIcon2 = /*#__PURE__*/_jsx(PrimaryIcon, {}))), type === 'gray-icon' && (_GrayIcon2 || (_GrayIcon2 = /*#__PURE__*/_jsx(GrayIcon, {}))), type === 'progress-indicator' && (_ProgressIndicatorIco2 || (_ProgressIndicatorIco2 = /*#__PURE__*/_jsx(ProgressIndicatorIcon, {}))), type === 'error-icon' && (_ErrorIcon2 || (_ErrorIcon2 = /*#__PURE__*/_jsx(ErrorIcon, {}))), type === 'warning-icon' && (_WarningIcon2 || (_WarningIcon2 = /*#__PURE__*/_jsx(WarningIcon, {}))), type === 'success-icon' && (_SuccesIcon2 || (_SuccesIcon2 = /*#__PURE__*/_jsx(SuccesIcon, {})))]
          })
        })]
      }), /*#__PURE__*/_jsxs("div", {
